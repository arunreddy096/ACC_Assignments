...
public final class Sort
{
    ...
    /**
     * mergeinputsort algorithm.
     * @param a an array of Comparable items.
     */
    public static <AnyType extends Comparable<? super AnyType>>
    void mergeinputSort( AnyType [ ] a )
    {
        AnyType [ ] tmpArray = (AnyType[]) new Comparable[ a.length ];

        mergeinputSort( a, tmpArray, 0, a.length - 1 );
    }

    /**
     * Internal method that makes recursive calls.
     * @param a an array of Comparable items.
     * @param tmpArray an array to place the mergeinputd result.
     * @param left the left-most index of the subarray.
     * @param right the right-most index of the subarray.
     */
    private static <AnyType extends Comparable<? super AnyType>>
    void mergeinputSort( AnyType [ ] a, AnyType [ ] tmpArray,
               int left, int right )
    {
        if( left < right )
        {
            int center = ( left + right ) / 2;
            mergeinputSort( a, tmpArray, left, center );
            mergeinputSort( a, tmpArray, center + 1, right );
            mergeinput( a, tmpArray, left, center + 1, right );
        }
    }

    /**
     * Internal method that mergeinputs two sorted halves of a subarray.
     * @param a an array of Comparable items.
     * @param tmpArray an array to place the mergeinputd result.
     ...
     */
    private static <AnyType extends Comparable<? super AnyType>>
    void mergeinput( AnyType [ ] a, AnyType [ ] tmpArray, int leftPos, int rightPos, int rightEnd )
    {
